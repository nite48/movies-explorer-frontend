    ...
    <section id="aboutMe" className="about">
      ...
      <div className="about__wrap">
        ...
        <div className="about__info">
          ...
          <p className="about__info-me">
            Родился в Липецке. Работаю Fullstack-разработчиком в группе компании
            "НЛМК". Живу в металлургческом городе, здесь одно из самых больших
