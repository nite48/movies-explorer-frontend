  ...
  return(
    <section className="register">
      <div className="register__content">
        ...
        <button type="submit" className="register__button-submit register__button-submit-in">Войти</button>
        <p className="register__info">Ещё не зарегистрированы? <Link to="/signup" className="register__redirect" >Регистрация</Link></p>
      </div>
    </section>
  )
}
