      ...
      <div className="profile__content">
        ...
        <form>
          <div className="profile__info">
            ...
            <input type="text" className="profile__input" defaultValue="" placeholder='Имя' />
          </div>
          <hr className='profile__line' />
          <div className="profile__info">
            <label className="profile__label">E-mail</label>
            <input type="text" className="profile__input" defaultValue="example@yandex.ru" placeholder='Email' />
          </div>
